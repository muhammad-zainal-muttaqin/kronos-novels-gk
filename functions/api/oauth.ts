      ...
      const html = `
        ...
        <html>
          <head>
            ...
            <style>
              body { font-family: -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif; display:flex; align-items:center; justify-content:center; height:100vh; margin:0; background:#fffbf0; }
              .message{ text-align:center; color:#2c3e50; }
              .success{ color:#a8d5ba; font-size:3rem; margin-bottom:1rem; }
            </style>
          </head>
          <body>
            <div class="message">
